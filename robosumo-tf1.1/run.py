...
def main(args):
    ...
    parser.add_argument('--save_path', help='Path to save trained model to', default='./saved_models/RoboSumo-Half_Cheetah-vs-Half_Cheetah.pkl', type=str)
    parser.add_argument('--log_path', help='Directory to save learning curve data.', default='./train_log', type=str)
...
# python run.py --env=RoboSumo-Half_Cheetah-vs-Half_Cheetah-v0 --network=mlp --num_timesteps=2e6 --save_path=saved_models/RoboSumo-Half_Cheetah-vs-Half_Cheetah.pkl --log_path=train_log